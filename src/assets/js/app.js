...
$(function() {
    ...
    if ($('#notificar').length > 0) {
        ...
        $('table td .form-group').on('change',function () {
            if($('table .form-group input[type=checkbox]:checked').length > 0){
              $('#notificar').removeClass('disabled');
              $('#notificar').addClass('enabled');
            } else {
...
$(function() {
	...
	$("body").addClass("loaded");
     ...
     if($('.tab-pane').length <= 1){
         var tablePar = $('.table').parent().parent().width(),
            tableHea = $('.table thead').width();
            console.log(tablePar);
        if( tableHea <= tablePar ){
            $('.table').addClass('fullwidth');
        }else{
        ...
        var tablePar1 = $('.table').parent().parent().width(),
            tableHea1 = $('.table thead').width();

            console.log('Table Parent ' + tablePar1);
             console.log('Table thead ' + tableHea1);

            if( tableHea1 <= tablePar1 ){
                $('.table').addClass('fullwidth');
            }else{
                $('.table').removeClass('fullwidth');
            }
        ...
        var tablePar1 = $('.title-block').width(),
            tableHea1 = $('.table thead').width();
